/*
 ...
 Source Schema         : studioeslam

 Target Server Type    : MySQL
 Target Server Version : 100411
 File Encoding         : 65001

 Date: 24/05/2020 16:42:54
*/
...
CREATE TABLE `billitems`  (
  ...
  INDEX `billitems_bill_id_foreign`(`bill_id`) USING BTREE,
  CONSTRAINT `billitems_bill_id_foreign` FOREIGN KEY (`bill_id`) REFERENCES `bills` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
